(function () {
  ...
  var EASY_LOCATION = "Internal storage/Download/RangkumanKerja";
  var FALLBACK_LOCATION = "Internal storage/Android/data/id.rangkumankerja.app/files/RangkumanKerja";
  ...
  // Simpan blob ke folder Download/RangkumanKerja lewat MediaStore (cara resmi Android,
  ...
  async function saveOrShareBlob(filename, blob, opts){
    ...
    if(fs){
      try{
        var relPath = "RangkumanKerja/" + filename;
